...
object Seasons {
  ...
  val requestSeasonEndpoint: PublicEndpoint[(String, TVShow.Id, Season.Number), ErrorInfo, RequestedSeason, Any] =
  ...
  val requestedCreditsForSeasonEndpoint: PublicEndpoint[(String, TVShow.Id, Season.Number), ErrorInfo, RequestedCreditsForSeason, Any] =
    Base.seasonBaseEndpoint(
  ...
  val requestedAggregateCreditsForSeasonEndpoint: PublicEndpoint[(String, TVShow.Id, Season.Number), ErrorInfo, RequestedAggregateCreditsForSeason, Any] =
    Base.seasonBaseEndpoint(
