...
object UserListsEndpoints {
  ...
  val userListsEndpoint: PublicEndpoint[(UserId, Option[String]), ErrorInfo, List[MediaContentList], Any] =
    userBaseEndpoint(
  ...
  val userSpecificListEndpoint: PublicEndpoint[(UserId, MediaContentListId), ErrorInfo, MediaContentList, Any] =
    userBaseEndpoint(
